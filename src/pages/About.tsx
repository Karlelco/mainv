    ...
    <div className="bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="mt-4 text-lg">
          We're changing the way people connect. At Venity Mall, we believe that
          ...
          electronics, and lifestyle products. Whether you’re searching for the
          latest trends, timeless classics, or unique finds, we’ve got you
          covered.
        </p>
        ...
        <div className="bg-gray-100 dark:bg-gray-700">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <p className="mt-4 text-lg">
              ...
              clear: to redefine online shopping. We’re not just another retail
              platform; we’re your trusted companion on the journey of
